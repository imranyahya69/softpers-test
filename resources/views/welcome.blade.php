...
@section('content')
    <div class="mt-5 ml-4 text-lg leading-7 font-semibold"><a href="upload_excel"
            class="underline text-gray-900 dark:text-white">Click here to upload excel files</a></div>
